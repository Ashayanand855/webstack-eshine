...
const baseCatalogProducts = [
  createProduct({
    ...
    name: 'Shirt',
    price: '₹899',
    img: '/pics/MEN/FORMAL/SHIRTS/1_42d735f4-15ce-4867-8494-c6e4a24f2fff.png',
    audience: 'men',
    category: 'top-wear',
    style: 'formal',
    ...
    colors: [
      createColor('Teal Green', 'Teal Green', '#9DB6B5', [
        '/pics/MEN/FORMAL/SHIRTS/1_42d735f4-15ce-4867-8494-c6e4a24f2fff.png',
      ]),
      createColor('Violet', 'Violet', '#B4B0C3', [
        '/pics/MEN/FORMAL/SHIRTS/4MSS1216-11-M22.png',
      ]),
      createColor('Black', 'Black', '##333134', [
        '/pics/MEN/FORMAL/SHIRTS/4MSS1813-10-M2737_85b2534e-7886-4fcb-8da4-4d105eccf6a5.png',
      ]),
    ],
  }),
  createProduct({
    ...
    name: 'Sweater',
    price: '₹2000',
    img: '/pics/MEN/CASUALS/Sweaters/15.jpg',
    audience: 'men',
    category: 'top-wear',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Sweatshirt',
    price: '₹5000',
    img: '/pics/MEN/CASUALS/Hoodies/hoodies_0.jpg',
    audience: 'men',
    category: 'top-wear',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'T-Shirt',
    price: '₹4200',
    img: '/pics/MEN/CASUALS/TSHIRT/20.jpg',
    audience: 'men',
    category: 'top-wear',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Kurta',
    price: '₹1290',
    img: '/pics/MEN/CASUALS/SHIRTS/13.jpg',
    audience: 'men',
    category: 'ethnic',
    style: 'festive',
  ...
  createProduct({
    ...
    name: 'Hoodie',
    price: '₹2900',
    img: '/pics/MEN/CASUALS/Hoodies/5.jpg',
    audience: 'men',
    category: 'outerwear',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Coat Pant',
    price: '₹4020',
    img: '/pics/MEN/FORMAL/PANTS/men_trousers0.jpg',
    audience: 'men',
    category: 'formal',
    style: 'formal',
  ...
  createProduct({
    ...
    name: 'Anarkali Set',
    price: '₹1290',
    img: '/pics/WOMEN/wedding/women_wedding_collection0.jpg',
    audience: 'women',
    category: 'ethnic',
    style: 'festive',
  ...
  createProduct({
    ...
    name: 'Kurta Set',
    price: '₹890',
    img: '/pics/WOMEN/Kurta Set/Screenshot 2026-03-22 at 09.49.18.png',
    audience: 'women',
    category: 'ethnic',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Dress',
    price: '₹580',
    img: '/pics/WOMEN/Dress/Screenshot 2026-03-22 at 09.31.20.png',
    audience: 'women',
    category: 'dress',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Formal Shirt',
    price: '₹420',
    img: '/pics/WOMEN/Shirt/Screenshot 2026-03-22 at 10.03.45.png',
    audience: 'women',
    category: 'formal',
    style: 'formal',
  ...
  createProduct({
    ...
    name: 'Lehenga',
    price: '₹1290',
    img: '/pics/WOMEN/wedding/women_wedding_collection1.jpg',
    audience: 'women',
    category: 'ethnic',
    style: 'festive',
  ...
  createProduct({
    ...
    name: 'Shrara',
    price: '₹890',
    img: '/pics/WOMEN/wedding/women_wedding_collection2.jpg',
    audience: 'women',
    category: 'ethnic',
    style: 'festive',
  ...
  createProduct({
    ...
    name: 'Coat Pant',
    price: '₹420',
    img: '/pics/WOMEN/formal/1266282fc945b8ca295bbb8b9f783774.jpg',
    audience: 'women',
    category: 'formal',
    style: 'formal',
  ...
  createProduct({
    ...
    name: 'Formal Pant',
    price: '₹580',
    img: '/pics/WOMEN/formal/9553cca573c5629b995ee41e3994d1d3.jpg',
    audience: 'women',
    category: 'formal',
    style: 'formal',
  ...
  createProduct({
    ...
    name: 'Hoodie',
    price: '₹1290',
    img: '/pics/WOMEN/casual/0808f9da5e7e9154cb03b6f26fd3bae1.jpg',
    audience: 'women',
    category: 'outerwear',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Jacket',
    price: '₹890',
    img: '/pics/WOMEN/casual/0f6e752c76a7b116fe4fc4d7746824e0.jpg',
    audience: 'women',
    category: 'outerwear',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Sweater',
    price: '₹420',
    img: '/pics/WOMEN/casual/1652ba28cdb7c3817d9667b3f00ee45b.jpg',
    audience: 'women',
    category: 'top-wear',
    style: 'casual',
  ...
  createProduct({
    ...
    name: 'Sweatshirt',
    price: '₹580',
    img: '/pics/WOMEN/T-Shirt/women_tshirts0.jpg',
    audience: 'women',
    category: 'top-wear',
    style: 'casual',
...
const menBulkImagePaths = [
  '/pics/MEN/CASUALS/Hoodies/hoodies_1.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_2.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_3.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_4.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_5.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_6.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_7.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_8.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_9.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_10.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_11.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_12.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_13.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_14.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_15.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_16.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_17.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_18.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_19.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_20.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_21.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_22.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_23.jpg',
  '/pics/MEN/CASUALS/Hoodies/hoodies_24.jpg',
];

const womenBulkImagePaths = [
  '/pics/WOMEN/T-Shirt/women_tshirts1.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts2.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts3.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts4.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts5.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts6.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts7.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts8.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts9.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts10.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts11.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts12.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts13.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts14.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts15.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts16.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts17.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts18.jpg',
  '/pics/WOMEN/T-Shirt/women_tshirts19.jpg',
];
